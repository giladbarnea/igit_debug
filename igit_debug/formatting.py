...
def pformat(obj, *, types=False, depth=1, default_formatter=repr) -> str:
    ...
    def _recursive_pformat(_obj, *, _types: bool, _depth: int) -> str:
        ...
        _formatted_items = []
        for _item in _obj:
            _formatted_item = pformat(_item, types=_types, depth=_depth, default_formatter=str)
